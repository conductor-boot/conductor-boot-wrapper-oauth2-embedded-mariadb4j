...
import com.my.conductorbootwrapperoauth2embeddedmariadb4j.dto.request.client.ClientResetPasswordRequest;
import com.my.conductorbootwrapperoauth2embeddedmariadb4j.dto.request.client.UserDeleteRequest;
...
public class OAuthClientActionsController {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully deleted user", 
                content = @Content(array = @ArraySchema(schema = @Schema(implementation = UserDeleteRequest.class)))) ,
