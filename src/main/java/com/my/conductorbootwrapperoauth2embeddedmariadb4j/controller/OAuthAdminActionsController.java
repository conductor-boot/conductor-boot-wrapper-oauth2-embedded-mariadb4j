...
import com.my.conductorbootwrapperoauth2embeddedmariadb4j.dto.request.admin.ClientRequest;
import com.my.conductorbootwrapperoauth2embeddedmariadb4j.dto.request.admin.ClientDeleteRequest;
import com.my.conductorbootwrapperoauth2embeddedmariadb4j.dto.request.admin.ClientResetPasswordWithClienIdRequest;
import com.my.conductorbootwrapperoauth2embeddedmariadb4j.dto.request.admin.UserDeleteWithClienIdRequest;
import com.my.conductorbootwrapperoauth2embeddedmariadb4j.dto.request.admin.UserResetPasswordWithClienIdRequest;
import com.my.conductorbootwrapperoauth2embeddedmariadb4j.dto.request.admin.UserWithClientIDRequest;
import com.my.conductorbootwrapperoauth2embeddedmariadb4j.dto.response.AutogeneratedPasswordResponseDTO;
...
private Logger logger = LoggerFactory.getLogger(OAuthAdminActionsController.class.getSimpleName());
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully onboarded new Client and persisted in Database", 
                content = @Content(array = @ArraySchema(schema = @Schema(implementation = ClientRequest.class)))) ,
	...
	public ResponseEntity<AutogeneratedPasswordResponseDTO> addClient(@RequestBody ClientRequest request)
	{
		try {
			...
			{
				String scope = Constants.STRING_INIT;
				
				for(String aScope: request.getScope())
				{
					if(!Constants.STRING_INIT.equalsIgnoreCase(scope))
					{
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully reset password.", 
                content = @Content(array = @ArraySchema(schema = @Schema(implementation = ClientResetPasswordWithClienIdRequest.class)))) ,
        @ApiResponse(responseCode = "400", description = "Client ID Not Found", content = @Content()),
        @ApiResponse(responseCode = "500", description = "Internal Server Error - Returned when an unexpected error occurs on server side", content = @Content())})
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully deleted client", 
                content = @Content(array = @ArraySchema(schema = @Schema(implementation = ClientDeleteRequest.class)))) ,
        @ApiResponse(responseCode = "400", description = "Client ID Not Found", content = @Content()),
        @ApiResponse(responseCode = "500", description = "Internal Server Error - Returned when an unexpected error occurs on server side", content = @Content())})
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully onboarded new User and persisted in Database", 
                content = @Content(array = @ArraySchema(schema = @Schema(implementation = UserWithClientIDRequest.class)))) ,
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully reset password.", 
                content = @Content(array = @ArraySchema(schema = @Schema(implementation = UserResetPasswordWithClienIdRequest.class)))) ,
        @ApiResponse(responseCode = "400", description = "Invalid Client Id.", content = @Content()),
        @ApiResponse(responseCode = "404", description = "User Not Found", content = @Content()),
        @ApiResponse(responseCode = "500", description = "Internal Server Error - Returned when an unexpected error occurs on server side", content = @Content())})
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully deleted user", 
                content = @Content(array = @ArraySchema(schema = @Schema(implementation = UserDeleteWithClienIdRequest.class)))) ,
